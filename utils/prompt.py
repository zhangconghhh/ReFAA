prompt_dgm4 = """[label] Base on the given text, and image, define if this news is matching or not.
text: {}
Is this news matching?"""


prompt_stage2_dgm4 = """[label] Base on the given text and image, define if this news is fake or not. If the news is fake, locate the fake area of the image and text.
text: {}"""

prompt_stage2_u = """[label] Base on the given text and image, define if this image-text pair is match or not. If the news is not match, locate the disinformation area of the image and text.
text: {}"""
